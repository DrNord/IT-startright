...
Современные ИСР обладают функциями включения несколько курсоров, сворачивания частей кода, выделения столбцом, автосохранения, поиска и замены, рефакторинга и многих других.  
...
- откройте Firefox;
- зайдите на страницу ```about:config```;
